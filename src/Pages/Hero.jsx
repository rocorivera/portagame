    ...
    <PageWrapper>
     <div className="min-h-screen bg-gradient-to-br from-[#0f172a] to-[#1e293b] text-white flex items-center justify-center">
      <div className="text-center flex flex-col items-center">
        ...
        {/* padre de la targeta */}
        <div className="mt-12 w-48 h-72 sm:w-56 sm:h-80 md:w-64 md:h-96 perspective cursor-pointer mb-10 overflow-hidden animate-epic-entrance" onClick={() => setVolteado(!volteado)}>
...
Busco espacios donde crecer profesionalmente creando algo memorable, y aportar con todo lo que sé mientras absorbo conocimiento de quienes dominan su arte.
        ...
        <button
        className="px-6 py-2 bg-purple-600 hover:bg-purple-700 rounded-lg transition duration-300 shadow-md">
        ...
        <a 
        href="https://github.com/rocorivera"
        target="_blank"
        rel="noopener noreferrer"
        className="mt-4 px-4 py-2 bg-gradient-to-r from-green-400 to-blue-500 text-white rounded-lg shadow-md hover:scale-105 trasition-transform">
          😼GitHub
        </a>
      </div>
    </div>
